...
enum L10n {
    ...
    enum Settings {
        ...
        static let sectionPlugins      = LocalizedStringResource("settings.section.plugins")
    ...
    enum Menu {
        ...
        static let closeOtherTabs  = LocalizedStringResource("menu.closeOtherTabs")
        static let closeTabsToRight = LocalizedStringResource("menu.closeTabsToRight")
        ...
        static let find            = LocalizedStringResource("menu.find")
        static let findNext        = LocalizedStringResource("menu.findNext")
        static let findPrevious    = LocalizedStringResource("menu.findPrevious")
